/**
  * Connect4.java
  * This program is an applet for playing a game of Connect 4 against the computer.
  ...
  * Dependencies: Board.java, Minimax.java, Position.java
  */
...
public class Connect4 extends Applet implements Runnable, ActionListener
{
  ...
  @Override
	...
	public void actionPerformed(ActionEvent e) 
	{
		...
		// Set our flag that will enable the thread to select moves.
		m_bGetNextMove = true;
